...
export default function PlancheBadgesScolaires({ eleves, onClose, schoolName, schoolLogo, export default function PlancheBadgesScolaires({ eleves, onClose, schoolName, schoolLogo, anneeScolaire = '2026-2027' }: Props) { }: Props) {
