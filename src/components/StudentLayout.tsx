...
import { BookOpen, Home, FileText, ClipboardList, Award, Bot, LogOut, CalendarDays, Star, PenTool, Calculator, GraduationCap, Palette, Bug, Languages } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { path: '/eleve/serpent', icon: Bug, label: 'Serpent ABC' },
  { path: '/eleve/anglais', icon: Languages, label: 'Anglais 🇬🇧' },
