...
export type AppRole = 'superviseur' | 'admin' | 'secretaire' | 'service_info' | 'comptable' | 'boutique' | 'cantine' | 'librairie' | 'coordinateur' | 'robotique' | 'chauffeur' | 'pointeur' | 'surveillant' | 'tresorier';
