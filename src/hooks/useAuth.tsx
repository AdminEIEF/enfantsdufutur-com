...
export type AppRole = 'superviseur' | 'admin' | 'secretaire' | 'service_info' | 'comptable' | 'boutique' | 'cantine' | 'librairie' | 'coordinateur' | 'coordinateur_secondaire' | 'robotique' | 'chauffeur' | 'pointeur' | 'surveillant' | 'tresorier';
