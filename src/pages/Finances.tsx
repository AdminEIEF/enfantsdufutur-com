...
const DEP_SERVICE_MAP: Record<string, string> = {
  ...
  'Librairie': 'fournitures', 'Fonctionnement': 'autre', 'Salaires': 'autre',
  'Pédagogie': 'autre', 'Maintenance': 'autre', 'Événements': 'autre',
  'Sécurité': 'autre', 'Santé': 'autre', 'Communication': 'autre', 'Autre': 'autre',
};
