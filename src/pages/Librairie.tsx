  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-3">
        <Card className="overflow-hidden border border-emerald-200 dark:border-emerald-800 bg-gradient-to-br from-emerald-500/10 via-emerald-500/5 to-transparent shadow-sm"><CardContent className="pt-4 flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-emerald-500/15 flex items-center justify-center"><Package className="h-5 w-5 text-emerald-600" /></div><div><p className="text-sm text-muted-foreground">Total articles</p><p className="text-xl font-bold text-emerald-700 dark:text-emerald-400">{articles.length}</p></div></CardContent></Card>
        <Card className="overflow-hidden border border-teal-200 dark:border-teal-800 bg-gradient-to-br from-teal-500/10 via-teal-500/5 to-transparent shadow-sm"><CardContent className="pt-4 flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-teal-500/15 flex items-center justify-center"><Package className="h-5 w-5 text-teal-600" /></div><div><p className="text-sm text-muted-foreground">Valeur du stock</p><p className="text-xl font-bold text-teal-700 dark:text-teal-400">{valeurStock.toLocaleString()} <span className="text-sm font-normal">GNF</span></p></div></CardContent></Card>
        <Card className={`overflow-hidden border shadow-sm ${stockBas > 0 ? 'border-amber-200 dark:border-amber-800 bg-gradient-to-br from-amber-500/10 via-amber-500/5 to-transparent' : ''}`}><CardContent className="pt-4 flex items-center gap-3"><div className={`w-10 h-10 rounded-lg flex items-center justify-center ${stockBas > 0 ? 'bg-amber-500/15' : 'bg-gray-500/15'}`}><AlertTriangle className={`h-5 w-5 ${stockBas > 0 ? 'text-amber-600' : 'text-muted-foreground'}`} /></div><div><p className="text-sm text-muted-foreground">Stock bas</p><p className={`text-xl font-bold ${stockBas > 0 ? 'text-amber-600' : ''}`}>{stockBas}</p></div></CardContent></Card>
        <Card className={`overflow-hidden border shadow-sm ${stockEpuise > 0 ? 'border-red-200 dark:border-red-800 bg-gradient-to-br from-red-500/10 via-red-500/5 to-transparent' : ''}`}><CardContent className="pt-4 flex items-center gap-3"><div className={`w-10 h-10 rounded-lg flex items-center justify-center ${stockEpuise > 0 ? 'bg-red-500/15' : 'bg-gray-500/15'}`}><AlertTriangle className={`h-5 w-5 ${stockEpuise > 0 ? 'text-red-600' : 'text-muted-foreground'}`} /></div><div><p className="text-sm text-muted-foreground">Épuisé</p><p className={`text-xl font-bold ${stockEpuise > 0 ? 'text-red-600' : ''}`}>{stockEpuise}</p></div></CardContent></Card>
      </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        <Card className="overflow-hidden border border-emerald-200 dark:border-emerald-800 bg-gradient-to-br from-emerald-500/10 via-emerald-500/5 to-transparent shadow-sm hover:shadow-md transition-shadow"><CardContent className="pt-6 flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-emerald-500/15 flex items-center justify-center"><Package className="h-5 w-5 text-emerald-600" /></div><div><p className="text-sm text-muted-foreground">Articles en stock</p><p className="text-2xl font-bold text-emerald-700 dark:text-emerald-400">{totalArticles}</p></div></CardContent></Card>
        <Card className="overflow-hidden border border-teal-200 dark:border-teal-800 bg-gradient-to-br from-teal-500/10 via-teal-500/5 to-transparent shadow-sm hover:shadow-md transition-shadow"><CardContent className="pt-6 flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-teal-500/15 flex items-center justify-center"><Tag className="h-5 w-5 text-teal-600" /></div><div><p className="text-sm text-muted-foreground">Valeur totale du stock</p><p className="text-2xl font-bold text-teal-700 dark:text-teal-400">{totalValeur.toLocaleString()} <span className="text-sm font-normal">GNF</span></p></div></CardContent></Card>
        <Card className="overflow-hidden border border-blue-200 dark:border-blue-800 bg-gradient-to-br from-blue-500/10 via-blue-500/5 to-transparent shadow-sm hover:shadow-md transition-shadow"><CardContent className="pt-6 flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-blue-500/15 flex items-center justify-center"><BookOpen className="h-5 w-5 text-blue-600" /></div><div><p className="text-sm text-muted-foreground">CA Ventes Librairie</p><p className="text-2xl font-bold text-blue-700 dark:text-blue-400">{totalVentes.toLocaleString()} <span className="text-sm font-normal">GNF</span></p></div></CardContent></Card>
        <Card className={`overflow-hidden border shadow-sm hover:shadow-md transition-shadow ${alertes > 0 ? 'border-amber-200 dark:border-amber-800 bg-gradient-to-br from-amber-500/10 via-amber-500/5 to-transparent' : 'border-gray-200 dark:border-gray-800 bg-gradient-to-br from-gray-500/10 via-gray-500/5 to-transparent'}`}><CardContent className="pt-6 flex items-center gap-3"><div className={`w-10 h-10 rounded-lg flex items-center justify-center ${alertes > 0 ? 'bg-amber-500/15' : 'bg-gray-500/15'}`}><AlertTriangle className={`h-5 w-5 ${alertes > 0 ? 'text-amber-600' : 'text-muted-foreground'}`} /></div><div><p className="text-sm text-muted-foreground">Alertes stock</p><p className={`text-2xl font-bold ${alertes > 0 ? 'text-amber-600' : 'text-muted-foreground'}`}>{alertes}</p></div></CardContent></Card>
      </div>
